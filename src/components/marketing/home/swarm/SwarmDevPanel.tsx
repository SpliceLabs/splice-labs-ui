  ...
  if (!open) {
    return (
      <button
        ...
        className="fixed bottom-4 left-4 z-50 px-3 py-2 font-mono text-meta uppercase tracking-wider border border-white/15 bg-black/70 text-foreground hover:bg-black/90 hover:border-electric-teal transition-colors backdrop-blur-sm"
  ...
  return (
    <div className="fixed bottom-4 left-4 z-50 w-[300px] border border-white/15 bg-black/85 backdrop-blur-sm font-mono text-foreground">
      <header className="flex items-center justify-between px-3 py-2 border-b border-white/10">
        <span className="text-label uppercase tracking-wider opacity-70">
          swarm
        </span>
        <div className="flex items-center gap-2">
          <select
            ...
            className="bg-transparent border border-white/15 px-1 py-0.5 text-label uppercase tracking-wider focus:outline-none focus:border-electric-teal"
          ...
          <button
            ...
            className="text-sm leading-none px-1 hover:text-electric-teal"
      ...
      <div className="flex items-center justify-between px-3 py-2 border-b border-white/10 text-label uppercase tracking-wider">
      ...
      <div className="flex items-center justify-between gap-2 px-3 py-2 border-b border-white/10 text-label uppercase tracking-wider">
        <label
