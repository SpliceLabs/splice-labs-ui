          ...
          <div className="grid grid-cols-1 gap-10">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <a href="/helios" className="group inline-flex items-center font-mono text-label-lg tracking-splice-wide uppercase text-accent transition-all duration-300 hover:text-ember hover:translate-x-1">
                ...
                <a href="#contact" className="group inline-flex items-center font-mono text-label-lg tracking-splice-wide uppercase text-muted-foreground transition-all duration-300 hover:text-foreground hover:translate-x-1">
                  <span className="relative">
