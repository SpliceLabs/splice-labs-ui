        ...
        <div className="md:w-1/2 md:mr-auto flex justify-center md:justify-start mask-fade-from-left">
         <div className="w-full max-w-[600px]">
          <div className="flex items-center gap-4 mb-10">
            ...
            <span className="font-mono text-eyebrow text-accent tracking-splice-ultra uppercase">
              module::platform
            </span>
          ...
          <div className="grid grid-cols-1 gap-10">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <a href="/helios" className="inline-flex items-center font-mono text-meta tracking-splice-wide uppercase text-accent hover:text-accent transition-colors">
                  Learn more about HELIOS →
                </a>
                <a href="#contact" className="inline-flex items-center font-mono text-meta tracking-splice-wide uppercase text-muted-foreground hover:text-foreground transition-colors">
            ...
            <div className="space-y-3">
              {[
                ...
                <div key={i} className="border border-surface-border p-3 flex items-center gap-3 card-lift">
                  ...
                  <span className="font-mono text-label text-foreground/60 tracking-splice-wide">
                    {l.layer}
                  </span>
                </div>
              ))}
