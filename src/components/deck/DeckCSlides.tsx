  ...
  return (
    <Slide id="c-title" module="title" accent slideNumber={slideNumber} totalSlides={totalSlides}>
      <div className="flex flex-col gap-10 min-h-[60vh] justify-center">
        <span className="font-mono text-eyebrow text-accent/50 tracking-splice-ultra uppercase border border-accent/20 px-2 py-0.5 self-start">
          Partnership Brief
        </span>
        {/* Logo — Terminal VA */}
  ...
  return (
    <Slide id="c-helios" module="helios" slideNumber={slideNumber} totalSlides={totalSlides}>
      ...
      <div className="border border-surface-border p-6">
        <span className="font-mono text-eyebrow text-accent/50 tracking-splice-ultra uppercase block mb-6">
          Architecture
        </span>
        <div className="flex flex-col gap-0">
          <div className="border border-accent/30 bg-accent/5 px-5 py-3 flex items-center justify-between">
            <span className="font-mono text-label text-accent tracking-splice-wide uppercase">L1 — Orchestration</span>
          ...
          <div className="grid grid-cols-3 gap-px">
            ...
            <div className="border border-accent/20 bg-accent/5 px-4 py-3 text-center">
              <span className="font-mono text-label text-accent/80 tracking-splice-wide uppercase">Risk Engine</span>
            </div>
            <div className="border border-surface-border px-4 py-3 text-center">
              <span className="font-mono text-label text-foreground/70 tracking-splice-wide uppercase">
                Compliance
        ...
        {models.map((m, i) => (
          <div key={i} className="border border-surface-border p-6 flex flex-col">
            ...
            <div className="border-t border-surface-border pt-3">
              <span className="font-mono text-eyebrow text-accent/40 tracking-splice-wide uppercase">Best fit: </span>
