  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <div className="min-w-0">
        <span className="font-mono text-meta text-foreground/80 block leading-tight">{label}</span>
        <span className="font-mono text-eyebrow text-muted-foreground/50 block leading-tight">{token}</span>
        <span className="font-mono text-eyebrow text-muted-foreground/40 block leading-tight">hsl({hsl})</span>
      </div>
    </div>
  );
}
  ...
  return (
    <Slide id="style-guide" module="appendix::style guide" slideNumber={slideNumber} totalSlides={totalSlides}>
      ...
      <div className="h-8 w-64 bg-foreground/8 mb-2 flex items-center">
        <span className="font-mono text-label text-accent/60 tracking-splice-wide uppercase">
          Typography & Color System
        </span>
      </div>
      <div className="h-4 w-[60%] max-w-[480px] bg-foreground/5 mb-10 flex items-center">
        <span className="font-mono text-eyebrow text-muted-foreground/50">
      ...
      <div className="border border-surface-border p-6 mb-8">
        <span className="font-mono text-eyebrow text-accent/60 tracking-splice-ultra uppercase block mb-5">
          Fonts
        </span>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            ...
            <span className="font-mono text-label text-muted-foreground/50 block mb-3">
          ...
          <div>
            ...
            <div className="mt-3 border-l-2 border-accent/20 pl-4">
              <span className="font-mono text-label text-muted-foreground/50 block">
                Letter-spacing tokens:
              </span>
              <span className="font-mono text-label text-muted-foreground/40 block">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        ...
        <div className="border border-surface-border p-6" style={{ backgroundColor: "hsl(210 14% 6%)", color: "hsl(210 20% 92%)" }}>
          <span className="font-mono text-eyebrow tracking-splice-ultra uppercase block mb-5" style={{ color: "hsl(174 100% 42% / 0.6)" }}>
            Dark Mode (Default)
          </span>
        ...
        <div className="border p-6" style={{ backgroundColor: "hsl(210 20% 96%)", color: "hsl(210 14% 12%)", borderColor: "hsl(210 10% 82%)" }}>
          <span className="font-mono text-eyebrow tracking-splice-ultra uppercase block mb-5" style={{ color: "hsl(174 100% 30% / 0.6)" }}>
            Light Mode
          </span>
          <div className="space-y-3">
            {LIGHT_COLORS.map((c) => (
      ...
      <div className="border-l-2 border-accent/20 pl-6 py-2">
        ...
        <span className="font-mono text-label text-muted-foreground/40 block mt-1">
