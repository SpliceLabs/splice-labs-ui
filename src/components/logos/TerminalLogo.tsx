...
export function TerminalWordmark({ accent = false, scale = "header", animated = false }: TerminalProps) {
  ...
  if (scale === "product") {
    return (
      <div className="inline-flex items-baseline font-mono text-label-lg">
  ...
  return (
    <div className="inline-flex items-baseline font-mono">
      ...
      />
      {animated ? (
        <span className="text-label-sm self-end ml-1" style={{ color: base, opacity: 0.4, letterSpacing: "0.18em" }}>
          {displayed}
        </span>
      ) : (
        <span className="text-label-sm self-end ml-1" style={{ color: base, opacity: 0.4, letterSpacing: "0.18em" }}>
