...
export function Pagination({
  ...
  const cell =
    "grid h-9 min-w-9 place-items-center px-2 font-mono text-[12px] uppercase tracking-[0.06em] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blog-ring-teal disabled:opacity-30";
