    ...
    <article id="article-body" className="bg-blog-paper text-blog-text-graphite">
      ...
      <CTABand
        ...
        action={
          <a
            href="/contact"
            className="inline-flex bg-blog-chip-ink px-6 py-3 font-mono text-label-lg uppercase tracking-[0.06em] text-blog-chip-text transition-opacity hover:opacity-90"
          >
            Request access
          </a>
        }
