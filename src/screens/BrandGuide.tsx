  ...
  return (
    <div className="group">
      ...
      <div className="mt-2 space-y-0.5">
        ...
        <p className="font-mono text-[10px] text-muted-foreground tracking-splice-wide">
          {copied ? "COPIED!" : color.hex}
        </p>
        <p className="font-mono text-[10px] text-muted-foreground/60 tracking-splice-wide">
          {color.token}
        </p>
        <p className="text-[11px] text-muted-foreground/50">{color.usage}</p>
      </div>
    </div>
  );
}
...
function DownloadableSlackIcon({ size, label }: { size: number; label: string }) {
  return (
    <div className="flex flex-col items-center gap-3">
      ...
      <p className="font-mono text-[10px] text-muted-foreground tracking-splice-wide uppercase text-center">{label}</p>
      <button
        onClick={() => {
        ...
        className="font-mono text-[10px] tracking-splice-wide uppercase text-accent hover:text-foreground transition-colors border border-accent/30 px-3 py-1 hover:border-accent"
      >
        Download PNG
      </button>
    </div>
  ...
  return (
    <div className="border border-surface-border p-6">
      <div className="flex items-center justify-between mb-4">
        <span className="font-mono text-[10px] text-muted-foreground tracking-splice-wide uppercase">{label}</span>
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-[1200px] mx-auto px-6 md:px-8 py-16 md:py-24">
        ...
        <header className="mb-20">
          <p className="font-mono text-[10px] text-accent tracking-splice-ultra uppercase mb-4">Brand Guidelines</p>
        ...
        <section className="mb-24">
          <div className="flex items-center gap-3 mb-8">
            <span className="font-mono text-[10px] text-accent tracking-splice-ultra uppercase">01</span>
          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="border border-surface-border p-6">
              <h3 className="font-mono text-[10px] text-muted-foreground tracking-splice-wide uppercase mb-3">Clear Space</h3>
            ...
            <div className="border border-surface-border p-6">
              <h3 className="font-mono text-[10px] text-muted-foreground tracking-splice-wide uppercase mb-3">Minimum Size</h3>
              <p className="text-sm text-muted-foreground">
        ...
        <section className="mb-24">
          <div className="flex items-center gap-3 mb-8">
            <span className="font-mono text-[10px] text-accent tracking-splice-ultra uppercase">02</span>
        ...
        <section className="mb-24">
          <div className="flex items-center gap-3 mb-8">
            <span className="font-mono text-[10px] text-accent tracking-splice-ultra uppercase">03</span>
          ...
          {/* Core */}
          <h3 className="font-mono text-[10px] text-muted-foreground tracking-splice-wide uppercase mb-4 mt-10">Core Palette</h3>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-10">
            {COLOR_SYSTEM.core.map((c) => <ColorSwatch key={c.token} color={c} />)}
          </div>

          {/* Surfaces */}
          <h3 className="font-mono text-[10px] text-muted-foreground tracking-splice-wide uppercase mb-4">Surface Layers</h3>
          <div className="grid grid-cols-2 md:grid-cols-3 gap-6 mb-10">
            {COLOR_SYSTEM.surfaces.map((c) => <ColorSwatch key={c.token} color={c} />)}
          </div>

          {/* Semantic */}
          <h3 className="font-mono text-[10px] text-muted-foreground tracking-splice-wide uppercase mb-4">Semantic Tokens</h3>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-10">
            {COLOR_SYSTEM.semantic.map((c) => <ColorSwatch key={c.token + c.name} color={c} />)}
          </div>

          {/* Extended */}
          <h3 className="font-mono text-[10px] text-muted-foreground tracking-splice-wide uppercase mb-4">Extended Palette — Warm Accents</h3>
          ...
          <div className="mt-10 border border-surface-border p-6">
            <h3 className="font-mono text-[10px] text-muted-foreground tracking-splice-wide uppercase mb-3">Usage Rules</h3>
            <ul className="text-sm text-muted-foreground space-y-2">
              ...
              <li>• Text on accent backgrounds must use the matching <code className="font-mono text-[11px] text-foreground">--*-foreground</code> token for WCAG AA compliance.</li>
              <li>• Surface layers create depth hierarchy. Use <code className="font-mono text-[11px] text-foreground">surface → surface-raised</code> for card elevation.</li>
        ...
        <section className="mb-24">
          <div className="flex items-center gap-3 mb-8">
            <span className="font-mono text-[10px] text-accent tracking-splice-ultra uppercase">04</span>
              ...
              <div key={t.role} className="border border-surface-border p-6 -mt-px first:mt-0">
                <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                  <div className="shrink-0 md:w-48">
                    <p className="font-mono text-[10px] text-accent tracking-splice-wide uppercase">{t.role}</p>
                    <p className="font-mono text-[10px] text-muted-foreground/60 tracking-splice-wide mt-1">{t.family}</p>
                    <p className="font-mono text-[10px] text-muted-foreground/40 tracking-splice-wide">{t.weight} · {t.size}</p>
                    <p className="font-mono text-[10px] text-muted-foreground/40 tracking-splice-wide">Tracking: {t.tracking}</p>
                  </div>
                  <div className="flex-1">
                    <p
                      className={`text-foreground ${
                        ...
                        "font-mono text-[11px] tracking-splice-wide uppercase text-muted-foreground"
                      }`}
                    >
                      {t.sample}
                    </p>
          ...
          <div className="mt-8 border border-surface-border p-6">
            <h3 className="font-mono text-[10px] text-muted-foreground tracking-splice-wide uppercase mb-4">Custom Tracking Tokens</h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div>
                <p className="font-mono text-[11px] text-foreground mb-1">splice-tight</p>
                <p className="font-mono text-[10px] text-muted-foreground/60">-0.04em</p>
                <p className="font-display text-xl font-bold tracking-splice-tight text-foreground mt-2">Splice Labs</p>
              </div>
              <div>
                <p className="font-mono text-[11px] text-foreground mb-1">splice-wide</p>
                <p className="font-mono text-[10px] text-muted-foreground/60">0.18em</p>
                <p className="font-mono text-sm tracking-splice-wide uppercase text-foreground mt-2">Protocol</p>
              </div>
              <div>
                <p className="font-mono text-[11px] text-foreground mb-1">splice-ultra</p>
                <p className="font-mono text-[10px] text-muted-foreground/60">0.28em</p>
                <p className="font-mono text-[10px] tracking-splice-ultra uppercase text-foreground mt-2">Section Label</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="mb-24">
          <div className="flex items-center gap-3 mb-8">
            <span className="font-mono text-[10px] text-accent tracking-splice-ultra uppercase">05</span>
            <h2 className="font-display text-2xl font-bold tracking-splice-tight text-foreground">Geometry & Rules</h2>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="border border-surface-border p-6">
              <h3 className="font-mono text-[10px] text-muted-foreground tracking-splice-wide uppercase mb-3">Border Radius</h3>
            ...
            <div className="border border-surface-border p-6">
              <h3 className="font-mono text-[10px] text-muted-foreground tracking-splice-wide uppercase mb-3">Grid Unit</h3>
              <p className="text-sm text-muted-foreground mb-4">
            ...
            <div className="border border-surface-border p-6">
              <h3 className="font-mono text-[10px] text-muted-foreground tracking-splice-wide uppercase mb-3">Prohibited</h3>
            ...
            <div className="border border-surface-border p-6">
              <h3 className="font-mono text-[10px] text-muted-foreground tracking-splice-wide uppercase mb-3">Voice & Tone</h3>
              <ul className="text-sm text-muted-foreground space-y-1">
        ...
        <section className="mb-16">
          <div className="flex items-center gap-3 mb-8">
            <span className="font-mono text-[10px] text-accent tracking-splice-ultra uppercase">06</span>
